...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Novo Delegado</a></li>
    </ol>
  </nav>
  ...
  <div class="row justify-content-center">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">Cadastro de Delegado</div>

        <div class="card-body">
          <form method="POST" action="{{ route('cadastro.delegado.submit') }}">
            @csrf
