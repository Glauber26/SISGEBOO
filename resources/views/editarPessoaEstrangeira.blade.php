...
<div class="container">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="http://localhost/SISGEBOO/public/admin/pessoas/estrangeiras">Estrangeiro</a></li>
          ...
          <form method="POST" action="{{$pessoa->id}}">
            ...
            <div class="form-group row">
              ...
              <div class="form-group col-md">
                <label for="inputRNE">Registro Nacional de Estrangeiro - RNE</label>
                <input type="text" class="form-control {{ $errors->has('rne') ? 'is-invalid' : '' }}" name="rne" id="rne" value="{{$pessoa->rne}}">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4">
                ...
                <input type="number" class="form-control  {{ $errors->has('passaporte') ? 'is-invalid' : '' }}" name="passaporte" id="passaporte" value="{{$pessoa->passaporte}}">
