        ...
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <a href="{{route('cadastro.pessoa.fisica')}}" class="btn btn-outline-primary my-2 my-sm-0">Sou uma pessoa física, desejo prosseguir!</a>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <a href="{{route('cadastro.pessoa.juridica')}}" class="btn btn-outline-primary my-2 my-sm-0">Sou uma pessoa Jurídica, desejo prosseguir!</a>
            </div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="card">
            <div class="card-body">
              ...
              <a href="{{route('cadastro.pessoa.estrangeira')}}" class="btn btn-outline-primary my-2 my-sm-0">Sou um estrangeiro, desejo prosseguir!</a>
            </div>
          </div>
        </div>
      </div>
