        ...
        <div class="col-md-12">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <input id="email" type="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" name="email" id="email" placeholder="E-Mail" value="{{ old('email') }}" required autocomplete="email">
                ...
                <div class="col-md-3">
                    ...
                    <input id="password" type="password" class="form-control{{ $errors->has('password') ? 'is-invalid' : '' }}" name="password" id="password" required autocomplete="new-password">
