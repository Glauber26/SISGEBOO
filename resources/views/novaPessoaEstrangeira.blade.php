    ...
    <div class="col-md-12">
     ...
     <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="http://localhost/SISGEBOO/public/identificacao">Identificação</a></li>
        <li class="breadcrumb-item active" aria-current="page">Cadastro de Estrangeiro</li>
      </ol>
    </nav>


    <div class="card">
      <div class="card-header">Cadastro de Estrangeiro</div>

      <div class="card-body">
        <form method="POST" action="{{ route('cadastro.pessoa.estrangeira.submit') }}">
          @csrf
          ...
          <div class="form-group row">
            ...
            <!--Campo Telefone-->
            <div class="col-md-3">
              <label for="inputRNE">Registro Nacional de Estrangeiro</label>
              <input type="number" class="form-control  {{ $errors->has('rne') ? 'is-invalid' : '' }}" name="rne" id="rne" placeholder="RNE" value="{{ old('rne') }}">
            ...
            <div class="form-group col-md-4">
              <label for="inputpassaporte">Passaporte</label>
              <input type="number" class="form-control {{ $errors->has('passaporte') ? 'is-invalid' : '' }}" name="passaporte" id="passaporte" placeholder="Passaporte" value="{{ old('passaporte') }}">
